...
/* icons */
import { faReact, faHtml5, faCss3, faPhp, faPython, faAws, faSass, faJs, faNode} from '@fortawesome/free-brands-svg-icons'
/* styles */
...
const projectList = () => {
  return (
    <section id='projectos'>
      ...
      <div id='project-list'>
        <Proyecto nombre={'Clismo'} img={clismo} type={'propio grupal'} descripcion={'Clismo es una pagina para ciclistas, tanto alumnos como profesores se conectan y se manejan las rutinas, los entrenamientos y los grupos'} tecnologias={[faReact, faPython]} link={"https://clismo.vercel.app/"}/>
